...
?>
  <form action="form2.php" method="POST">
    ...
    <input type="text"  name="firstname" placeholder="Dennis"><br><br>
    ...
    <input type="tel" name="address" id=""><br> <Br>
    <label>Language: <span class="red">* </label>
    <input type="checkbox" name="languange[]" value="html">htmlcle
